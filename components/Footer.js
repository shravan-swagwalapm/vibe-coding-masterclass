        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* X/Twitter */}
              <a 
                href="https://x.com/shravantickoo23" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition"
              >
              ...
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/swagwalapm/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://www.youtube.com/@TheSwagWalaPM" target="_blank" rel="noopener noreferrer" className="rs-footer-link">YouTube Channel</a></li>
              <li><a href="https://rethinksystems.in" target="_blank" rel="noopener noreferrer" className="rs-footer-link">Rethink Systems</a></li>
